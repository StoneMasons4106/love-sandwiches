...
def update_worksheet(data_one, data_two):
    """Update sales and surplus worksheet, add new rows with the list provided."""
    print("Updating sales worksheet...\n")
    sales_worksheet = SHEET.worksheet('sales')
    sales_worksheet.append_row(data_one)
    print("Sales worksheet updated successfully!")
    print("Updating surplus worksheet...\n")
    surplus_worksheet = SHEET.worksheet('surplus')
    surplus_worksheet.append_row(data_two)
...
def main():
    ...
    update_worksheet(sales_data, new_surplus_data)
